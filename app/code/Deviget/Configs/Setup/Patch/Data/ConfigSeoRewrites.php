...
class ConfigSeoRewrites implements DataPatchInterface
{
    /**
    ...
    /**
     * Change Default Configs constructor.
     ...
     */
    private function changeConfigs(\Magento\Store\Model\Website $website): void
    {
